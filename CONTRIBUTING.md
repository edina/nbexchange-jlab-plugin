...
In order to work, this JupyterLab extension requires to connect to a [NbExchange](https://github.com/edina/nbexchange) 
service that should be setup and running before starting the jupyterLab notebook.
